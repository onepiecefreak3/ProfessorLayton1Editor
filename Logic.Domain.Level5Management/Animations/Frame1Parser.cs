...
class Frame1Parser(IFrame1Reader reader) : IFrame1Parser
{
    ...
    public AnimationSequences Parse(Frame1Container container)
    {
    ...
    private AnimationFrame[] ParseFrames(Frame1Container container)
    {
    ...
    private AnimationSequence[] ParseAnimations(Frame1Container container)
    {
