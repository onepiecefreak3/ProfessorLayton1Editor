...
public class MethodInvocationParametersSyntax : SyntaxNode
{
    ...
    public CommaSeparatedSyntaxList<LiteralExpressionSyntax>? ParameterList { get; private set; }
    ...
    public MethodInvocationParametersSyntax(SyntaxToken parenOpen,
        CommaSeparatedSyntaxList<LiteralExpressionSyntax>? parameterList,
    ...
    public void SetParameterList(CommaSeparatedSyntaxList<LiteralExpressionSyntax>? parameterList, bool updatePosition = true)
    {
        if (parameterList != null)
            parameterList.Parent = this;
